...
import '../styles/toggleV2.css';


export default function Toggle(props) {

  return (
    <label className="toggle" style={{font:`${props.size}em/1.5 sans-serif`}} title={props.text}>
        <input className="toggle_input" type="checkbox" checked={props.value} onChange={(e) => props.onChange(props.index,e)} />
